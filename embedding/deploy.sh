...
IMAGE="embedding_image"                                      # 镜像名
TAG="latest"                                                 # 镜像标签
CONTAINER="embedding"                                        # 容器名
HOST_PORT=8088                                               # 宿主机外部端口
APP_PORT=8088                                                # 容器内服务端口
RESTART_POLICY="always"                                      # 重启策略
USE_BUILDKIT=true                                            # BuildKit 加速
MODEL_DIR="$(dirname "$(pwd)")/models/bge-m3"                # 权重模型目录
